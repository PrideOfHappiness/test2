        ...
        <div class="mt-4"> 
            <section class="content"> 
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kode_jenis" name="kode_jenis" value="{{ $jenis_users->kode_jenis }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="nama_jenis" class="form-label">Jenis Kendaraan</label>
                    <input type="text" class="form-control" id="nama_jenis" name="nama_jenis" value="{{ $jenis_users->nama_jenis }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="keterangan" class="form-label">Keterangan Jenis</label>
                    <textarea class="form-control" id="keterangan" name="keterangan" readonly> {{ $jenis_users->keterangan }} </textarea>
                </div>
                <div class="mb-3">
